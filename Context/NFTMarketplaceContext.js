...
const projectId = "2TFtHXXMfQrHCD1zY3UizmlMpKW";
const projectSecretKey = "4df8928fa5f87d41697c6594f4efcb62";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "https://nftmarketplac.infura-ipfs.io";
  ...
  const fetchNFTs = async () => {
    try {
      const provider = new ethers.providers.JsonRpcProvider(
        ...
        "https://polygon-mumbai.g.alchemy.com/v2/U1oX7c2_k5q8ZtboaOvVqewYKcTarpqK"
      );
